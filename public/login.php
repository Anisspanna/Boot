               ...
               <main class="row justify-content-center">
                      <article style="max-width: 550px; border: 1px solid #eee; border-radius: 20px; background-color: #ffffff;" class="col-sm p-3">
                        <form  method="post" action="loginvalidation.php">
                          ...
                          <div>
                            <h2 id="titre" class="text-center p-2">Se Connecter</h2>
                          ...
                          <div class="mb-4">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1" name="email" aria-describedby="emailHelp" placeholder="Entrer votre email">
                            <?php if(isset($_SESSION['e_email'])) echo '<p class="text-danger">'.$_SESSION['e_email'].'</p>'; unset($_SESSION['e_email']);?>
                          </div>
                          <div class="mb-4">
                            <label for="exampleInputPassword1" class="form-label">Mot de passe</label>
                            <input type="password" class="form-control" id="exampleInputPassword1" name="password" placeholder="Entrer votre Mot de passe">
                            <?php if(isset($_SESSION['e_password'])) echo '<p class="text-danger">'.$_SESSION['e_password'].'</p>'; unset($_SESSION['e_password']);?>

                          </div>
                          <h6 class="mt-3 text-center">Vous avez oublié votre mot de passe? <a href="forgetpass.php">récupérer Le</a></h6>
                          <div>
                            <button style="width: 100%; background-color: #1984bc; color: #ffffff; font-size: large;" type="submit" name="login" class="btn">Connecter</button>
                          </div>  
                          

                          <h6 class="mt-3 text-center">Vous n'êtes pas encore inscrit ? <a href="inscription.php">Inscrivez-vous</a></h6>
