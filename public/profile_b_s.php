...
{
    $stmt_verif_session=$connection->prepare("SELECT `vsidentite`, `nom_donneur_s`, `prenom_donneur_s`, `ville_donneur_s`, `telephone_donneur_s`, `sexe_donneur_s`, `email_donneur_s`, `valide_token_donneur`, `blastek` From `bnadms` WHERE `email_donneur_s`= ? LIMIT 1 ");
 ...
 transform: scale(0.8);
                ...
                <div class="main-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                 <form action="savedata_b_s.php" method="post">
	<!-- Chart -->						<input type="hidden" name="csrf_token" value="<?=$_SESSION['ana_hwa']?>" id="">
              ...
              <option value="El Menia">El Menia</option>
						...
						<div class="row">
							<form action="newpassbanc.php" method="post">
					...
					<div class="row">
						<div class="col-sm-12">
							<form action="deleteacc_b_s.php" method="post">
