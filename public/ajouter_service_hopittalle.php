            ...
            <section class="container-fluid">
                <main class="row">
                     <article class="col-sm">
						<form action="ajouter_service_hopitale.php" method="post">
                        <div class="card">
                            <div class="card-body">
								<input type="hidden" name="csrf_token" value="<?=$_SESSION['ana_hwa']?>" id="">
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Nom d'hopitale</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="nom_h" class="form-control" >
									<?php if(isset($_SESSION['e_nom_h'])) echo '<p class="text-danger">'.$_SESSION['e_nom_h'].'</p>'; unset($_SESSION['e_nom_h']);?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
									<select name="ville_h" class="form-select">
              ...
              <option value="El Menia">El Menia</option>
							...
							<?php if(isset($_SESSION['e_ville_h'])) echo '<p class="text-danger">'.$_SESSION['e_ville_h'].'</p>'; unset($_SESSION['e_ville_h']);?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="email" name="email_h" class="form-control">
									<?php if(isset($_SESSION['e_email_h'])) echo '<p class="text-danger">'.$_SESSION['e_email_h'].'</p>'; unset($_SESSION['e_email_h']);?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="password" name="password_h" class="form-control">
									<?php if(isset($_SESSION['e_password_h'])) echo '<p class="text-danger">'.$_SESSION['e_password_h'].'</p>'; unset($_SESSION['e_password_h']);?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="telephone_h" class="form-control">
									<?php if(isset($_SESSION['e_telephone_h'])) echo '<p class="text-danger">'.$_SESSION['e_telephone_h'].'</p>'; unset($_SESSION['e_telephone_h']);?>
								...
								<div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
											<button style="width: 100%; background-color: #1984bc; color: #ffffff; font-size: large;" type="submit" name="Ajouterhopitale" class="btn">Ajouter</button>
