...
<head>
    ...
    <title>Ajouter service hopital ou clinique</title>
</head>
<body>
		...
		<main>
            ...
            <section class="container-fluid">
                     ...
                     <article class="col-sm">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Nom Banc du sang</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="nom_b_s" class="form-control" >
									<?php if(isset($_SESSION['e_nom_b_s'])) echo '<p class="text-danger">'.$_SESSION['e_nom_b_s'].'</p>'; unset($_SESSION['e_nom_b_s']);?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
									<select name="ville_b_s" class="form-select">
              ...
              <option value="El Menia">El Menia</option>
							...
							<?php if(isset($_SESSION['e_ville_b_s'])) echo '<p class="text-danger">'.$_SESSION['e_ville_b_s'].'</p>'; unset($_SESSION['e_ville_b_s']);?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="email" name="email_b_s" class="form-control">
									<?php if(isset($_SESSION['e_email_b_s'])) echo '<p class="text-danger">'.$_SESSION['e_email_b_s'].'</p>'; unset($_SESSION['e_email_b_s']);?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="password" name="password_b_s" class="form-control">
									<?php if(isset($_SESSION['e_password_b_s'])) echo '<p class="text-danger">'.$_SESSION['e_password_b_s'].'</p>'; unset($_SESSION['e_password_b_s']);?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="telephone_b_s" class="form-control">
									<?php if(isset($_SESSION['e_telephone_b_s'])) echo '<p class="text-danger">'.$_SESSION['e_telephone_b_s'].'</p>'; unset($_SESSION['e_telephone_b_s']);?>
								...
								<div class="row mb-3">
									...
									<?php if(isset($_SESSION['e_addresse_s'])) echo '<p class="text-danger">'.$_SESSION['e_addresse_s'].'</p>'; unset($_SESSION['e_addresse_s']);?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="latitude_b_s" class="form-control">
									<?php if(isset($_SESSION['e_latitude'])) echo '<p class="text-danger">'.$_SESSION['e_latitude'].'</p>'; unset($_SESSION['e_latitude']);?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="longitude_b_s" class="form-control">
									<?php if(isset($_SESSION['e_longitude'])) echo '<p class="text-danger">'.$_SESSION['e_longitude'].'</p>'; unset($_SESSION['e_longitude']);?>
								...
								<div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
											<button style="width: 100%; background-color: #1984bc; color: #ffffff; font-size: large;" type="submit" name="Ajouter" class="btn">Ajouter</button>
