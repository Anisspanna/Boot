...
{
	$stmt_verif_session=$connection->prepare("SELECT `vsidentite`, `nom_donneur_s`, `sexe_donneur_s`, `prenom_donneur_s`, `groupage_donneur_s`, `dernier_donneur_s`, `agesdonneur_s`, `email_donneur_s`, `valide_token_donneur`, `blastek` From `bnadms` WHERE `email_donneur_s`= ? LIMIT 1 ");
...
@media screen and (max-width: 768px) {
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li>
				<a href="#"><i class='bx bxs-inbox icon' ></i> chercher donneurs/ Centres du don <i class='bx bx-chevron-right icon-right' ></i></a>
				<ul class="side-dropdown">
				<li><a href="chercher_donneur.php">Chercher Donneurs</a></li>
					<li><a href="maps.php">Chercher Centres du dons</a></li>
					
				</ul>
			</li>
			
			<li class="divider" data-text="table and forms">Table and forms</li>
			<li><a href="profile.php"><i class='bx bx-table icon' ></i> Profile</a></li>
		...
		<main>
			...
			<div class="info-data">
				<div class="card">
					<div class="head">
						<div>
							<h2><?= $row['nom_donneur_s'].' '.$row['prenom_donneur_s']?></h2>
							<b><?= $row['agesdonneur_s'].' Ans'?></b>
						</div>
						
						<h4 class="text-danger"><b><?= $row['groupage_donneur_s'] ?></b></h4>
						
					</div>
					
					<b>Dernier Don: <?= $dernier?></b>
					<b><?= ucfirst($row['sexe_donneur_s']) ?></b><br>
