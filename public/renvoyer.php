          ...
          <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div  class="d-flex" >
                    <a href="inscription.php" class="btn btn-outline-danger me-3">Inscription</a>
                      ...
                      <article style="max-width: 550px; border: 1px solid #eee; border-radius: 20px; background-color: #ffffff;" class="col-sm p-3">
                        <form  method="post" action="resend.php">
                          ...
                          <input type="hidden" name="csrf_token" value="<?=$_SESSION['ana_hwa']?>" id="">
                            <h2 id="titre" class="text-center p-2">Renvoyer le lien de confirmation</h2>
                        ...
                        <div>
                            <button style="width: 100%; background-color: #1984bc; color: #ffffff; font-size: large;" type="submit" name="renvoyer" class="btn">Renvoyer</button>
                          </div>  
