...
{
	$stmt_verif_session=$connection->prepare("SELECT  `nom_donneur_s`, `telephone_donneur_s`, `email_donneur_s`, `ville_donneur_s`, `valide_token_donneur`, `blastek` From `bnadms` WHERE `email_donneur_s`= ? LIMIT 1 ");
            ...
            <section class="container-fluid">
                <main class="row">
                     <article class="col-sm">
                        <div class="card">
                            <div class="card-body">
                            <form method="post" action="enregistrerdonneurs_Hopitale.php">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select name="groupage_donneur2" class="form-select " >
                                            <option value="groupage" selected disabled>Groupage Patient</option>
                                            <option value="O+">O+</option>
                                            <option value="A+">A+</option>
                                            <option value="B+">B+</option>
                                            <option value="AB+">AB+</option>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Nom hopitale</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <select name="hopitaux" class="form-select">
                                            <option value="" selected disabled>Hopitaux</option>
